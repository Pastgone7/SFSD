...
class MVTecDataset(torch.utils.data.Dataset):
    ...
    def load_dataset(self):
        ...
        assert len(img_tot_paths) == len(gt_tot_paths), "Something wrong with modules and ground truth pair!"
...
def load_data(dataset_name='mnist',normal_class=0,batch_size='16'):
    ...
    if dataset_name == 'cifar10':
        ...
        os.makedirs("./Dataset/CIFAR10/modules", exist_ok=True)
        test_set = CIFAR10("./Dataset/CIFAR10/modules", train=False, download=True, transform=img_transform)
        ...
        os.makedirs("./Dataset/MNIST/modules", exist_ok=True)
        test_set = MNIST("./Dataset/MNIST/modules", train=False, download=True, transform=img_transform)
        print("Test Train Data:", test_set.data.shape)
        ...
        os.makedirs("./Dataset/FashionMNIST/modules", exist_ok=True)
        test_set = FashionMNIST("./Dataset/FashionMNIST/modules", train=False, download=True, transform=img_transform)
        print("Test Train Data:", test_set.data.shape)
        ...
        test_data_path = 'Dataset/OCT2017/modules'
